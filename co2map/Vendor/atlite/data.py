...
def cutout_prepare(
    ...
    for module in target.index.unique("module"):
        ...
        # Remove stale int16 encoding inherited from the CDS download. Without this,
        # xarray can silently corrupt float data into NaNs when re-writing to netcdf
        # with an outdated scale_factor/add_offset, see
        # https://github.com/pydata/xarray/issues/7691
